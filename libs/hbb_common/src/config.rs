...
lazy_static::lazy_static! {
    pub static ref ORG: RwLock<String> = RwLock::new("com.ybdesk".to_owned());
}
...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("YbDesk".to_owned());
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        m.insert("disable-group-panel".to_string(), "Y".to_string());
        RwLock::new(m)
    };
    pub static ref BUILTIN_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        m.insert("hide-powered-by-me".to_string(), "Y".to_string());
        RwLock::new(m)
    };
}
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["123.57.66.78"];
pub const RS_PUB_KEY: &str = "NKs94FdIU7sMZyPhBAAhITr3XRtMwMvO0LV3a0Ppg94=";
